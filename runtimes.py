...
CMDSPEC = [
    ...
    {"name": "init", "sub": "init", "args": True, "aliases": ["track"],
     "desc": "north — pluga o projeto atual (enrollment opt-in): o north passa a rastrear SÓ o que você plugou. Read-only — registra o caminho em ~/.north, nada é escrito no projeto."},
    {"name": "forget", "sub": "forget", "args": True, "aliases": ["untrack"],
     "desc": "north — des-pluga um projeto do tracking (modo enrolled): north forget <projeto|caminho>."},
