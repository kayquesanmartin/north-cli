---
name: north-inbox
description: north — Triagem da inbox de capturas. Lista as ideias/notas/lembretes salvos com /north-note e ajuda a decidir cada um (validar/fazer agora, ou descartar). Ative para "/north-inbox", "minhas ideias", "o que eu anotei", "revisar capturas", "triar a inbox", "aquelas ideias que salvei".
allowed-tools: Bash, Read
argument-hint: ""
---

# /north-inbox — Triagem de capturas (north)

Revisa o que foi capturado com `/north-note` e ajuda a dar destino a cada item.
