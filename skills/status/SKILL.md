---
name: status
description: north — Mostra o que está instalado, as pastas varridas (scan_roots) e os projetos rastreados. Ative para "/status", "north status", "o que o north está vendo", "quais projetos rastreados", "o que está configurado".
allowed-tools: Bash
argument-hint: ""
---

# /status — Estado do north
...
2. Apresente a saída formatada. Se não houver scan_roots ou projetos, oriente o
   usuário a adicionar uma pasta com `/config add-root "<pasta>"`.
